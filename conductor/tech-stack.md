...
## Database & ORM
- **SQLite3**: A reliable, file-based database architecture that avoids external server requirements.
- **Prisma ORM**: A modern and type-safe database toolkit for streamlined database operations and migrations.

## Security & Reliability
- **Helmet.js**: Enhanced security by setting various HTTP headers to protect against common attacks.
- **Validator.js**: Robust validation for user input and reservation data.
- **Winston/Logger**: Structured JSON logging for system monitoring and debugging.
